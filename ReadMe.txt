========================================================================
    KONSOLENANWENDUNG: 10b_protected-Projektübersicht
========================================================================

Diese 10b_protected-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre 10b_protected-Anwendung besteht.


10b_protected.vcxproj
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "10b_protected.pch und eine 
